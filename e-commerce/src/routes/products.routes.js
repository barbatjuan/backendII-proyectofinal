...
router.delete("/:pid", passportCall("jwt"), authRole(["admin"]), async (req, res) => {
  try {
    const { pid } = req.params;
...
router.put("/", validateSchema(editProductSchema), passportCall("jwt"), authRole(["admin"]), async (req, res) => {
  try {
    const { pid } = req.params;
...
router.post("/", passportCall("jwt"), authRole(["admin"]), async (req, res) => {
  try {
    const productData = req.body;
